...
class ResNet34_UNet(nn.Module):
    def __init__(self, num_classes=1):
        ...
        self.enc2 = self.encoder.layer1  # conv2_x, (B, 64, H/2, W/2)
        self.enc3 = self.encoder.layer2  # conv3_x, (B, 128, H/4, W/4)
        self.enc4 = self.encoder.layer3  # conv4_x, (B, 256, H/8, W/8)
        self.enc5 = self.encoder.layer4  # conv5_x, (B, 512, H/16, W/16)
